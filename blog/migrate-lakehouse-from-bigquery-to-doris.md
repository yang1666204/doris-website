...
- New versions may occasionally have bugs, so it's recommended to check if the [community](https://discord.gg/JemTbMKj) has reported any issues before deciding to upgrade.
