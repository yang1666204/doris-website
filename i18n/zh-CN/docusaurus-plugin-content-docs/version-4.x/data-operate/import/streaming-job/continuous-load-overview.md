...
| 数据源 | 单表导入 | 多表导入 | 配置指南 |
|:------|:--------|:--------|:--------|
| MySQL | [MySQL 单表导入](./continuous-load-mysql-single.md) | [MySQL 多表导入](./continuous-load-mysql-multi.md) | [Amazon RDS MySQL](./prerequisites/amazon-rds-mysql.md) · [Amazon Aurora MySQL](./prerequisites/amazon-aurora-mysql.md) |
| PostgreSQL | [PostgreSQL 单表导入](./continuous-load-postgresql-single.md) | [PostgreSQL 多表导入](./continuous-load-postgresql-multi.md) | [Amazon RDS PostgreSQL](./prerequisites/amazon-rds-postgresql.md) · [Amazon Aurora PostgreSQL](./prerequisites/amazon-aurora-postgresql.md) |
