---
{
  "title": "Doris カタログ",
  "language": "ja",
  "description": "Doris カタログは複数のDorisクラスター間でのクロスクラスター連合分析をサポートしています。Arrow FlightとVirtual クラスターの両方のモードをサポートし、分散データウェアハウスシナリオにおいて効率的なマルチクラスターデータクエリ、書き込み、および連合分析を可能にします。"
}
---
...
JDBC カタログを通じて他のDorisクラスターに接続する場合とは異なり、このソリューションはArrow FlightまたはVirtual クラスターモードを通じて、複数のDorisクラスター間で効率的な連携分析を可能にします。
